...
let _ = process_definition defs ctxt "_ && False := False"
let _ = process_definition defs ctxt "False && _ := False"
let _ = process_definition defs ctxt "True && True := True"
...
let _ = process_definition defs ctxt "(*) : right, 30 :: {A B :: Type} -> A -> B -> multType A B"
